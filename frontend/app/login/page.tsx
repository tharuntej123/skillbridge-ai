...
export default function LoginPage() {
  ...
  return (
    <div className="flex-1 flex items-center justify-center py-12 px-4 sm:px-6 lg:px-8 relative">
      <div className="absolute top-10 left-10 h-64 w-64 rounded-full bg-primary/5 blur-[100px]" />
      <div className="absolute bottom-10 right-10 h-64 w-64 rounded-full bg-accent/5 blur-[100px]" />
      
      <div className="max-w-md w-full space-y-8 glass-card p-8 md:p-10 rounded-3xl z-10">
        <div className="text-center">
          <h2 className="text-3xl font-extrabold text-white tracking-tight">Welcome Back</h2>
          <p className="mt-2 text-sm text-muted-foreground">
            Sign in to access your jobs and learning roadmaps
          </p>
        </div>
